  ...
  const handleSignOut = async () => {
    ...
    try {
      ...
      toast({
        ...
        description:
          "There was a problem signing out. You have been logged out locally.",
        variant: "destructive",
        duration: 5000,
      });
  ...
  return (
    <header
      className={`sticky top-0 z-50 w-full transition-all duration-300 ${
        scrolled
          ? "bg-background/95 backdrop-blur supports-[backdrop-filter]:bg-background/60 border-b border-[hsl(var(--border))] shadow-md shadow-primary/5"
          : "bg-transparent"
      }`}
    >
